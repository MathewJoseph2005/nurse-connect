...
const EditNurseProfile = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const { data: profile } = await supabase
          .from("nurses")
          .select(
            "id, name, phone, age, gender, division_id, current_department_id, experience_years, exam_score_percentage, divisions:divisions(id, name), departments:departments(id, name)"
          )
          .eq("user_id", user.id)
          .maybeSingle();
        ...
        if (profile) {
          ...
          setDepartmentId(profile.current_department_id || "");
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (departmentId) updateData.current_department_id = departmentId;
